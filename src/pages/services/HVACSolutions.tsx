            ...
            <section className="container-fluid py-5">
                ...
                <div className="row justify-content-center g-4">
                    ...
                    <div className="col-md-8">
                        <div className="card h-100 shadow-sm border-0">
                            <div className="card-body">
                                <h4 className="card-title fw-bold">Ducting Fabrication</h4>
                    ...
                    <div className="col-md-8">
                        ...
                        <div className="card h-100 shadow-sm border-0">
                            <div className="card-body">
                                <h4 className="card-title fw-bold">Chillers</h4>
                                <p className="card-text">
                    ...
                    <div className="col-md-8">
                        ...
                        <div className="card h-100 shadow-sm border-0">
                            <div className="card-body">
                                <h4 className="card-title fw-bold">Air Handling Units (AHUs)</h4>
                                <p className="card-text">
                    ...
                    <div className="col-md-8">
                        ...
                        <div className="card h-100 shadow-sm border-0">
                            <div className="card-body">
                                <h4 className="card-title fw-bold">Maintenance</h4>
                                <p className="card-text">
